        ...
        >
          <div className="w-full max-w-2xl overflow-hidden rounded-xl border border-black/10 bg-[#f5f5f5] shadow-2xl">
            <div className="flex items-center gap-2 border-b border-black/10 bg-[#ebebeb] px-4 py-3">
              ...
              <span className="ml-3 text-xs text-black/40">Terminal — zsh</span>
            </div>

            <div className="space-y-3 p-6 font-mono text-sm leading-relaxed text-black md:p-8 md:text-base">
              ...
              <div className="flex flex-wrap items-center gap-x-2">
                ...
                <span>
                  {displayed}
                  <motion.span
                    className="inline-block w-[8px] bg-black/80"
                    animate={{ opacity: [1, 0] }}
